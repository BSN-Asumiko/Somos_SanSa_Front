const CardSample = ({ className, headerText, children, showHeader = true }) => {
    return (
        <div className={`border-[color:var(--col-yellow)] border-4 border-solid bg-transparent rounded-[1.25rem] w-[90%] m-auto text-[color:var(--col-blue)] py-[1.19em] px-[1.13em] ${className}`}>
            {showHeader && (
